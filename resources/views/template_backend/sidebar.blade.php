<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class=active><a class="nav-link" href="{{ route('home')}}"><i class="fab fa-firstdraft"></i> <span>Dashboard</span></a></li>
        ...
        <li class="dropdown">
          <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-clipboard"></i> <span>Kategory</span></a>
          <ul class="dropdown-menu">
